# PackMate - Your Travel Packing Assistant
...
![listscreen](repo-assets/image-1.png)
...
![inside list](repo-assets/image-2.png)
...
![dark mode lists](repo-assets/image-3.png)
![dark mode paking list](repo-assets/image-4.png)
...
*   **Șterge o categorie**: Ține apăsat pe un card sau folosește opțiunea de ștergere (dacă este disponibilă în UI). ![delete](repo-assets/image-5.png)
*   **Schimbă Tema**: Folosește comutatorul din Bară (AppBar) sau setări pentru a trece pe modul Întunecat/Luminos. ![day](repo-assets/image-6.png), ![night](repo-assets/image-7.png)

### Ecranul Listă (Checklist)
Odată intrat într-o categorie:
*   **Adaugă un obiect**: Apasă butonul `+` și scrie numele obiectului. ![add item](repo-assets/image-8.png)
...
](repo-assets/image-9.png)
*   **Șterge obiecte**: Activează modul de ștergere (dacă există un meniu dedicat sau swipe) pentru a elimina lucruri inutile.![delete item](repo-assets/image-10.png)
